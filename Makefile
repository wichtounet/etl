...
CXX_FLAGS += $(shell pkg-config --cflags cublas-12.2)
CXX_FLAGS += $(shell pkg-config --cflags cufft-12.2)
CXX_FLAGS += $(shell pkg-config --cflags cudnn)
CXX_FLAGS += $(shell pkg-config --cflags curand-12.2)
...
ifneq (,$(ETL_CUBLAS))
CXX_FLAGS += -DETL_CUBLAS_MODE $(shell pkg-config --cflags cublas-12.2)
LD_FLAGS += $(shell pkg-config --libs cublas-12.2)
LD_FLAGS += $(shell pkg-config --libs cuda-12.2)
LD_FLAGS += $(shell pkg-config --libs cudart-12.2)
endif
...
ifneq (,$(ETL_CUFFT))
CXX_FLAGS += -DETL_CUFFT_MODE $(shell pkg-config --cflags cufft-12.2)
LD_FLAGS += $(shell pkg-config --libs cufft-12.2)
LD_FLAGS += $(shell pkg-config --libs cuda-12.2)
LD_FLAGS += $(shell pkg-config --libs cudart-12.2)
endif
...
ifneq (,$(ETL_CURAND))
CXX_FLAGS += -DETL_CURAND_MODE $(shell pkg-config --cflags curand-12.2)
LD_FLAGS += $(shell pkg-config --libs curand-12.2)
LD_FLAGS += $(shell pkg-config --libs cuda-12.2)
LD_FLAGS += $(shell pkg-config --libs cudart-12.2)
endif
...
$(eval $(call add_test_executable,etl_test_avg_pool_upsample_3d,src/test.cpp src/avg_pool_upsample_3d.cpp))
$(eval $(call add_test_executable,etl_test_avg_pool_upsample_deep,src/test.cpp src/avg_pool_upsample_deep.cpp))
...
$(eval $(call add_test_executable,etl_test_max_pool_upsample_3d,src/test.cpp src/max_pool_upsample_3d.cpp))
$(eval $(call add_test_executable,etl_test_max_pool_upsample_deep,src/test.cpp src/max_pool_upsample_deep.cpp))
...
$(eval $(call add_test_executable,etl_test_transpose_front,src/test.cpp src/transpose_front.cpp))
...
$(eval $(call add_executable,benchmark_benchmark,benchmark/src/benchmark_base.cpp benchmark/src/benchmark.cpp))
$(eval $(call add_executable,benchmark_cdbn,benchmark/src/benchmark_base.cpp benchmark/src/benchmark_cdbn.cpp))
$(eval $(call add_executable,benchmark_conv,benchmark/src/benchmark_base.cpp benchmark/src/benchmark_conv.cpp))
$(eval $(call add_executable,benchmark_conv_extended,benchmark/src/benchmark_base.cpp benchmark/src/benchmark_conv_extended.cpp))
$(eval $(call add_executable,benchmark_fft,benchmark/src/benchmark_base.cpp benchmark/src/benchmark_fft.cpp))
$(eval $(call add_executable,benchmark_gemm,benchmark/src/benchmark_base.cpp benchmark/src/benchmark_gemm.cpp))
