...
static void mm_mul(A&& a, B&& b, C&& c) {
    static constexpr const bool row_major = decay_traits<A>::storage_order == order::RowMajor;
...
static void vm_mul(A&& a, B&& b, C&& c) {
    static constexpr const bool row_major = decay_traits<B>::storage_order == order::RowMajor;
