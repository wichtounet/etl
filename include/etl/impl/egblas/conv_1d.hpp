...
#ifdef EGBLAS_HAS_SCONV1_FULL
static constexpr bool has_sconv1_full = true;
#else
static constexpr bool has_sconv1_full = false;
#endif

/*!
 * \brief Wrappers for single-precision egblas conv1_full operation
 * \param n The size of the input vector
 * \param k The size of the kernel vector
 * \param alpha The scaling factor alpha
 * \param A The memory of the input vector
 ...
 * \param ldc The leading dimension of the output vector
 */
inline void conv1_full([[maybe_unused]] size_t       n,
                       [[maybe_unused]] size_t       k,
                       [[maybe_unused]] float        alpha,
                       [[maybe_unused]] const float* A,
                       [[maybe_unused]] size_t       lda,
...
#ifdef EGBLAS_HAS_SCONV1_FULL
    inc_counter("egblas");
    egblas_sconv1_full(n, k, alpha, A, lda, B, ldb, C, ldc);
#else
    cpp_unreachable("Invalid call to egblas::conv1_full");
#endif
}

#ifdef EGBLAS_HAS_DCONV1_FULL
static constexpr bool has_dconv1_full = true;
#else
static constexpr bool has_dconv1_full = false;
#endif

/*!
 * \brief Wrappers for double-precision egblas conv1_full operation
 * \param n The size of the vector
 * \param alpha The scaling factor alpha
 * \param A The memory of the vector a
 * \param lda The leading dimension of a
...
#ifdef EGBLAS_HAS_DCONV1_FULL
    inc_counter("egblas");
    egblas_dconv1_full(n, k, alpha, A, lda, B, ldb, C, ldc);
#else
    cpp_unreachable("Invalid call to egblas::conv1_full");
#endif
}
