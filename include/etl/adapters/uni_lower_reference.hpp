...
/*!
 * \file
 * \brief Contains uni lower triangular matrix reference proxy implementation.
 */
...
namespace uni_lower_detail {

/*!
 * \brief A proxy representing a reference to a mutable element of a uni lower triangular matrix
 * \tparam M The matrix type
 */
template <typename M>
struct uni_lower_reference {
     ...
     */
    uni_lower_reference(matrix_type& matrix, std::size_t i, std::size_t j)
...
} //end of namespace uni_lower_detail
