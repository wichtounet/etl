...
struct strictly_upper_matrix final : adapter<Matrix>, comparable<strictly_upper_matrix<Matrix>>, iterable<const strictly_upper_matrix<Matrix>> {
    ...
    static_assert(is_square_matrix<matrix_t>::value, "Strictly upper triangular matrix must be square");
...
public:
     ...
     */
    strictly_upper_detail::strictly_upper_reference<matrix_t> operator()(std::size_t i, std::size_t j) noexcept {
        return {matrix, i, j};
    }
