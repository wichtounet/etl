...
/*!
 * \file
 * \brief Contains strictly upper triangular matrix reference proxy implementation.
 */
...
namespace strictly_upper_detail {

/*!
 * \brief A proxy representing a reference to a mutable element of a strictly upper triangular matrix
 * \tparam M The matrix type
 */
template <typename M>
struct strictly_upper_reference {
    ...
    /*!
     * \brief Constructs a new strictly_upper_reference
     * \param matrix The source matrix
     * \param i The index i of the first dimension
     * \param j The index j of the second dimension
     */
    strictly_upper_reference(matrix_type& matrix, size_t i, size_t j) : matrix(matrix), i(i), j(j), value(matrix(i, j)) {
