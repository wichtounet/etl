...
auto avg_upsample_2d(E&& /*input*/, F&& /*output*/){
    return 1.0 / (C1 * C2);
}

template<std::size_t C1, std::size_t C2, std::size_t C3, typename E, typename F>
auto avg_upsample_3d(E&& /*input*/, F&& /*output*/){
    return 1.0 / (C1 * C2 * C3);
}

template<std::size_t C1, std::size_t C2, typename E, typename F>
auto max_upsample_2d(E&& in, F&& out) -> temporary_binary_expr<value_t<E>, detail::build_type<E>, detail::build_type<F>, max_upsample_2d_expr<value_t<E>, C1, C2>, void> {
    return temporary_binary_expr<value_t<E>, detail::build_type<E>, detail::build_type<F>, max_upsample_2d_expr<value_t<E>, C1, C2>, void>{in, out};
}

template<std::size_t C1, std::size_t C2, std::size_t C3, typename E, typename F>
auto max_upsample_3d(E&& in, F&& out) -> temporary_binary_expr<value_t<E>, detail::build_type<E>, detail::build_type<F>, max_upsample_3d_expr<value_t<E>, C1, C2, C3>, void> {
    return temporary_binary_expr<value_t<E>, detail::build_type<E>, detail::build_type<F>, max_upsample_3d_expr<value_t<E>, C1, C2, C3>, void>{in, out};
}
