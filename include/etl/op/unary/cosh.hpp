...
struct cosh_unary_op {
     ...
     */
    template <typename E>
    static constexpr bool gpu_computable = (is_single_precision_t<T> && impl::egblas::has_scosh) || (is_double_precision_t<T> && impl::egblas::has_dcosh)
                                           || (is_complex_single_t<T> && impl::egblas::has_ccosh) || (is_complex_double_t<T> && impl::egblas::has_zcosh);
