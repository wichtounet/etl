...
#include "etl/impl/egblas/and.hpp"
...
struct logical_and_binary_op {
    ...
    static constexpr bool gpu_computable = impl::egblas::has_band;
    ...
    static auto gpu_compute_hint(const X& x, const Y& y, YY& yy) noexcept {
        ...
        impl::egblas::logical_and(etl::size(yy), t1.gpu_memory(), 1, t2.gpu_memory(), 1, t3.gpu_memory(), 1);
    ...
    static YY& gpu_compute(const X& x, const Y& y, YY& yy) noexcept {
        ...
        impl::egblas::logical_and(etl::size(yy), t1.gpu_memory(), 1, t2.gpu_memory(), 1, yy.gpu_memory(), 1);
