...
struct less_equal_binary_op {
    ...
    static constexpr bool gpu_computable =
               (all_single_precision<L,R> && impl::egblas::has_sless_equal)
    ...
    static auto gpu_compute_hint(const X& x, const Y& y, YY& yy) noexcept {
        ...
        impl::egblas::less_equal(etl::smart_size(x, y), t1.gpu_memory(), inca, t2.gpu_memory(), incb, t3.gpu_memory(), 1);
    ...
    static YY& gpu_compute(const X& x, const Y& y, YY& yy) noexcept {
        ...
        impl::egblas::less_equal(etl::smart_size(x, y), t1.gpu_memory(), inca, t2.gpu_memory(), incb, yy.gpu_memory(), 1);
