...
struct less_equal_binary_op {
    ...
    static auto gpu_compute(const X& x, const Y& y) noexcept {
        ...
        impl::egblas::less_equal(etl::size(x), t1.gpu_memory(), 1, t2.gpu_memory(), 1, t3.gpu_memory(), 1);
    ...
    static YY& gpu_compute(const X& x, const Y& y, YY& yy) noexcept {
        ...
        impl::egblas::less_equal(etl::size(x), t1.gpu_memory(), 1, t2.gpu_memory(), 1, yy.gpu_memory(), 1);
