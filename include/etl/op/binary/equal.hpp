...
#include "etl/impl/egblas/equal.hpp"
...
struct equal_binary_op {
    ...
    static constexpr bool gpu_computable =
               (all_single_precision<L,R> && impl::egblas::has_sequal)
            || (all_double_precision<L,R> && impl::egblas::has_dequal)
            || (all_complex_single_precision<L,R> && impl::egblas::has_cequal)
            || (all_complex_double_precision<L,R> && impl::egblas::has_zequal);
    ...
    static auto gpu_compute(const X& x, const Y& y) noexcept {
        ...
        impl::egblas::equal(etl::size(x), t1.gpu_memory(), 1, t2.gpu_memory(), 1, t3.gpu_memory(), 1);
    ...
    static YY& gpu_compute(const X& x, const Y& y, YY& yy) noexcept {
        ...
        impl::egblas::equal(etl::size(x), t1.gpu_memory(), 1, t2.gpu_memory(), 1, yy.gpu_memory(), 1);
