...
#include "etl/impl/egblas/log10.hpp"
...
struct log2_unary_op {
    ...
    template <typename E>
    static constexpr bool gpu_computable =
               (is_single_precision_t<T> && impl::egblas::has_slog2)
            || (is_double_precision_t<T> && impl::egblas::has_dlog2)
            || (is_complex_single_t<T> && impl::egblas::has_clog2)
            || (is_complex_double_t<T> && impl::egblas::has_zlog2);
    ...
    static auto gpu_compute(const X& x) noexcept {
        ...
        T alpha(1.0);
        impl::egblas::log2(etl::size(x), &alpha, t1.gpu_memory(), 1, t2.gpu_memory(), 1);
    ...
    static Y& gpu_compute(const X& x, Y& y) noexcept {
        ...
        T alpha(1.0);
        impl::egblas::log2(etl::size(x), &alpha, t1.gpu_memory(), 1, y.gpu_memory(), 1);
...
/*!
 * \brief Unary operation taking the logarithmic value (base 10)
 * \tparam T The type of value
 */
template <typename T>
struct log10_unary_op {
    ...
    template <typename V = default_vec>
    static vec_type<V> load(const vec_type<V>& x) noexcept {
        return V::div(V::log(x), V::log(V::set(T(10))));
    }
    ...
    static auto gpu_compute(const X& x) noexcept {
        ...
        T alpha(1.0);
        impl::egblas::log10(etl::size(x), &alpha, t1.gpu_memory(), 1, t2.gpu_memory(), 1);
    ...
    static Y& gpu_compute(const X& x, Y& y) noexcept {
        ...
        T alpha(1.0);
        impl::egblas::log10(etl::size(x), &alpha, t1.gpu_memory(), 1, y.gpu_memory(), 1);
...
struct cos_unary_op {
    ...
    static auto gpu_compute(const X& x) noexcept {
        ...
        T alpha(1.0);
        impl::egblas::cos(etl::size(x), &alpha, t1.gpu_memory(), 1, t2.gpu_memory(), 1);
    ...
    static Y& gpu_compute(const X& x, Y& y) noexcept {
        ...
        T alpha(1.0);
        impl::egblas::cos(etl::size(x), &alpha, t1.gpu_memory(), 1, y.gpu_memory(), 1);
