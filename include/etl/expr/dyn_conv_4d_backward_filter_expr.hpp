...
struct dyn_conv_4d_backward_filter_expr : base_temporary_expr_bin<dyn_conv_4d_backward_filter_expr<A, B, Flipped>, A, B> {
    using value_type  = value_t<A>;                                      ///< The type of value of the expression
    using this_type   = dyn_conv_4d_backward_filter_expr<A, B, Flipped>; ///< The type of this expression
     ...
     */
    explicit dyn_conv_4d_backward_filter_expr(A a, B b, size_t s1, size_t s2, size_t p1, size_t p2) : base_type(a, b), s1(s1), s2(s2), p1(p1), p2(p2) {
     ...
     */
    friend std::ostream& operator<<(std::ostream& os, const dyn_conv_4d_backward_filter_expr& expr) {
...
struct etl_traits<etl::dyn_conv_4d_backward_filter_expr<A, B, Flipped>> {
    using expr_t       = etl::dyn_conv_4d_backward_filter_expr<A, B, Flipped>; ///< The expression type
    ...
    static size_t size(const expr_t& e) {
        return etl::dim(e._b, 1) * etl::dim(e._a, 1) * (etl::dim(e._a, 2) - (e.s1 * (etl::dim(e._b, 2) - 1) + 1) + 2 * e.p1 + 1)
...
dyn_conv_4d_backward_filter_expr<detail::build_type<A>, detail::build_type<B>, false> conv_4d_backward_filter(
    ...
    return dyn_conv_4d_backward_filter_expr<detail::build_type<A>, detail::build_type<B>, false>{a, b, s1, s2, p1, p2};
}
...
auto conv_4d_backward_filter(A&& a, B&& b, C&& c, size_t s1, size_t s2, size_t p1, size_t p2) {
    ...
    c = conv_4d_backward_filter(a, b, s1, s2, p1, p2);
 ...
 */
template <typename A, typename B>
dyn_conv_4d_backward_filter_expr<detail::build_type<A>, detail::build_type<B>, true> conv_4d_backward_filter_flipped(
    A&& a, B&& b, size_t s1, size_t s2, size_t p1, size_t p2) {
    static_assert(all_etl_expr<A, B>, "Convolution only supported for ETL expressions");
...
auto conv_4d_backward_filter_flipped(A&& a, B&& b, C&& c, size_t s1, size_t s2, size_t p1, size_t p2) {
    ...
    c = conv_4d_backward_filter_flipped(a, b, s1, s2, p1, p2);
