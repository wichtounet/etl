        ...
        if constexpr_select (impl == etl::conv_impl::VEC) {
            ...
            if constexpr (parallel_support) {
                ...
                if (parallel_dispatch) {
                    ...
                    engine_dispatch_1d([&](size_t first, size_t last) { impl::vec::conv1_valid(input, kernel, conv, first, last); },
                                       0,
                                       etl::size(conv),
                                       parallel_dispatch);
                } else {
            ...
            if constexpr (parallel_support) {
                ...
                if (parallel_dispatch) {
                    ...
                    engine_dispatch_1d([&](size_t first, size_t last) { impl::standard::conv1_valid(input, kernel, conv, first, last); },
                                       0,
                                       etl::size(conv),
                                       parallel_dispatch);
                } else {
