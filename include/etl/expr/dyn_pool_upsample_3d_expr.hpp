...
struct dyn_pool_upsample_3d_expr : base_temporary_expr_tern<dyn_pool_upsample_3d_expr<A, B, C>, A, B, C> {
    using value_type = value_t<A>;                                   ///< The type of value of the expression
    using sub_traits = etl::decay_traits<A>;                         ///< The traits of the first sub type
    using this_type  = dyn_pool_upsample_3d_expr<A, B, C>;           ///< The type of this expression
 ...
 */
template <typename A, typename B, typename C>
struct etl_traits<etl::dyn_pool_upsample_3d_expr<A, B, C>> {
    using expr_t     = etl::dyn_pool_upsample_3d_expr<A, B, C>; ///< The expression type
 ...
 */
template <typename A, typename B, typename C>
dyn_pool_upsample_3d_expr<detail::build_type<A>, detail::build_type<B>, detail::build_type<C>> max_pool_upsample_3d(A&& input, B&& output, C&& errors, size_t c1, size_t c2, size_t c3) {
    using detail::build_type;
    return dyn_pool_upsample_3d_expr<detail::build_type<A>, detail::build_type<B>, detail::build_type<C>>{input, output, errors, c1, c2, c3};
}
