...
public:
     ...
     */
    dyn_pool_upsample_3d_expr(A a, B b, C c, size_t c1, size_t c2, size_t c3) : base_type(a, b, c), c1(c1), c2(c2), c3(c3) {
...
dyn_pool_upsample_3d_expr<detail::build_type<A>, detail::build_type<B>, detail::build_type<C>, true> max_pool_upsample_3d(
 ...
 */
template <typename A, typename B, typename C>
dyn_pool_upsample_3d_expr<detail::build_type<A>, detail::build_type<B>, detail::build_type<C>, false> avg_pool_upsample_3d(
    A&& input, B&& output, C&& errors, size_t c1, size_t c2, size_t c3) {
    return {input, output, errors, c1, c2, c3};
}
