...
struct dyn_pool_3d_expr : base_temporary_expr_un<dyn_pool_3d_expr<A, Impl>, A> {
    ...
    void assign_to(L&& lhs)  const {
        static_assert(all_etl_expr<A, L>::value, "pool_2d only supported for ETL expressions");
 ...
 */
template <typename E>
dyn_pool_3d_expr<detail::build_type<E>, impl::standard::avg_pool_3d> avg_pool_3d(E&& value, size_t c1, size_t c2, size_t c3) {
    return dyn_pool_3d_expr<detail::build_type<E>, impl::standard::avg_pool_3d>{value, c1, c2, c3, c1, c2, c3, 0, 0, 0};
}
 ...
 */
template <typename E>
dyn_pool_3d_expr<detail::build_type<E>, impl::standard::avg_pool_3d> avg_pool_3d(E&& value, size_t c1, size_t c2, size_t c3, size_t s1, size_t s2, size_t s3, size_t p1 = 0, size_t p2 = 0, size_t p3 = 0) {
    return dyn_pool_3d_expr<detail::build_type<E>, impl::standard::avg_pool_3d>{value, c1, c2, c3, s1, s2, s3, p1, p2, p3};
}
