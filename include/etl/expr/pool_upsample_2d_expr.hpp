...
struct pool_upsample_2d_expr : base_temporary_expr_tern<pool_upsample_2d_expr<A, B, C, C1, C2>, A, B, C> {
    using value_type = value_t<A>;                                   ///< The type of value of the expression
    using sub_traits = etl::decay_traits<A>;                         ///< The traits of the first sub type
    using this_type  = pool_upsample_2d_expr<A, B, C, C1, C2>;       ///< The type of this expression
 ...
 */
template <typename A, typename B, typename C, size_t C1, size_t C2>
struct etl_traits<etl::pool_upsample_2d_expr<A, B, C, C1, C2>> {
    using expr_t     = etl::pool_upsample_2d_expr<A, B, C, C1, C2>; ///< The expression type
...
pool_upsample_2d_expr<detail::build_type<A>, detail::build_type<B>, detail::build_type<C>, C1, C2> max_pool_upsample_2d(A&& input, B&& output, C&& errors) {
    using detail::build_type;
    return pool_upsample_2d_expr<detail::build_type<A>, detail::build_type<B>, detail::build_type<C>, C1, C2>{input, output, errors};
}
