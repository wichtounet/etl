...
CPM_DIRECT_SECTION_TWO_PASS_NS_PF("sconv2_valid_flipped [conv][conv2]", conv_2d_large_policy,
    ...
    CPM_SECTION_FUNCTOR("vec", [](smat& a, smat& b, smat& r){ r = selected_helper(etl::conv_impl::VEC, etl::conv_2d_valid_flipped(a, b)); })
    SSE_SECTION_FUNCTOR("sse", [](smat& a, smat& b, smat& r){ r = selected_helper(etl::conv_impl::SSE, etl::conv_2d_valid_flipped(a, b)); })
    AVX_SECTION_FUNCTOR("avx", [](smat& a, smat& b, smat& r){ r = selected_helper(etl::conv_impl::AVX, etl::conv_2d_valid_flipped(a, b)); })
...
CPM_DIRECT_SECTION_TWO_PASS_NS_PF("sconv2_full_flipped [conv][conv2]", conv_2d_large_policy,
    ...
    SSE_SECTION_FUNCTOR("sse", [](smat& a, smat& b, smat& r){ r = selected_helper(etl::conv_impl::SSE, etl::conv_2d_full_flipped(a, b)); })
    AVX_SECTION_FUNCTOR("avx", [](smat& a, smat& b, smat& r){ r = selected_helper(etl::conv_impl::AVX, etl::conv_2d_full_flipped(a, b)); })
...
CPM_DIRECT_SECTION_TWO_PASS_NS_PF("sconv2_full_multi [conv][conv2]", conv_2d_multi_policy,
    ...
    SSE_SECTION_FUNCTOR("sse", [](smat& a, smat3& b, smat3& r){ r = selected_helper(etl::conv_multi_impl::SSE, etl::conv_2d_full_multi(a, b)); })
    AVX_SECTION_FUNCTOR("avx", [](smat& a, smat3& b, smat3& r){ r = selected_helper(etl::conv_multi_impl::AVX, etl::conv_2d_full_multi(a, b)); })
...
CPM_DIRECT_SECTION_TWO_PASS_NS_PF("sconv2_full_multi_flipped [conv][conv2]", conv_2d_multi_policy,
    ...
    SSE_SECTION_FUNCTOR("sse", [](smat& a, smat3& b, smat3& r){ r = selected_helper(etl::conv_multi_impl::SSE, etl::conv_2d_full_multi_flipped(a, b)); })
    AVX_SECTION_FUNCTOR("avx", [](smat& a, smat3& b, smat3& r){ r = selected_helper(etl::conv_multi_impl::AVX, etl::conv_2d_full_multi_flipped(a, b)); })
...
CPM_DIRECT_SECTION_TWO_PASS_NS_PF("sconv2_valid_multi_multi_flipped [conv][conv2]", conv_2d_multi_multi_policy,
    ...
    SSE_SECTION_FUNCTOR("sse", [](smat3& a, smat3& b, smat4& r){ r = selected_helper(etl::conv_multi_impl::SSE, etl::conv_2d_valid_multi_multi_flipped(a, b)); })
    AVX_SECTION_FUNCTOR("avx", [](smat3& a, smat3& b, smat4& r){ r = selected_helper(etl::conv_multi_impl::AVX, etl::conv_2d_valid_multi_multi_flipped(a, b)); })
...
CPM_DIRECT_SECTION_TWO_PASS_NS_PF("sconv4_full_flipped [conv][conv4]", conv_4d_full_policy,
    FLOPS([](std::size_t n, std::size_t c, std::size_t k, std::size_t i, std::size_t w){ return 2 * n * c * k * i * i * w * w; }),
    CPM_SECTION_INIT([](std::size_t n, std::size_t c, std::size_t k, std::size_t i, std::size_t w){
        return std::make_tuple(smat4(n, k, i, i), smat4(k, c, w, w), smat4(n, c, i + w - 1, i + w - 1)); }),
    ...
    SSE_SECTION_FUNCTOR("sse", [](smat4& a, smat4& b, smat4& r){ r = selected_helper(etl::conv4_impl::SSE, etl::conv_4d_full_flipped(a, b)); })
    AVX_SECTION_FUNCTOR("avx", [](smat4& a, smat4& b, smat4& r){ r = selected_helper(etl::conv4_impl::AVX, etl::conv_4d_full_flipped(a, b)); })
