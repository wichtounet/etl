...
CPM_DIRECT_SECTION_TWO_PASS_NS_PF("sconv4_full_flipped [conv][conv4]", conv_4d_full_policy,
    ...
    MKL_SECTION_FUNCTOR("fft_mkl", [](smat4& a, smat4& b, smat4& r){ r = selected_helper(etl::conv_impl::FFT_MKL, etl::conv_4d_full_flipped(a, b)); })
    CUFFT_SECTION_FUNCTOR("fft_cufft", [](smat4& a, smat4& b, smat4& r){ r = selected_helper(etl::conv_impl::FFT_CUFFT, etl::conv_4d_full_flipped(a, b)); })
