...
CPM_DIRECT_SECTION_TWO_PASS_NS_PF("A * B (s) [gemm]", square_policy,
    ...
    CPM_SECTION_FUNCTOR("eblas", [](smat& a, smat& b, smat& c){ c = selected_helper(etl::gemm_impl::FAST, a * b); })
...
CPM_DIRECT_SECTION_TWO_PASS_NS_PF("A * B (cm/s) [gemm]", square_policy,
    ...
    CPM_SECTION_FUNCTOR("eblas", [](smat_cm& a, smat_cm& b, smat_cm& c){ c = selected_helper(etl::gemm_impl::FAST, a * b); })
...
CPM_DIRECT_SECTION_TWO_PASS_NS_PF("A * B (d) [gemm]", square_policy,
    ...
    CPM_SECTION_FUNCTOR("eblas", [](dmat& a, dmat& b, dmat& c){ c = selected_helper(etl::gemm_impl::FAST, a * b); })
...
CPM_DIRECT_SECTION_TWO_PASS_NS_PF("A * x (s) [gemm]", gemv_policy,
    ...
    CPM_SECTION_FUNCTOR("vec", [](smat& a, svec& b, svec& c){ c = selected_helper(etl::gemm_impl::VEC, a * b); })
...
CPM_DIRECT_SECTION_TWO_PASS_NS_PF("A * x (d) [gemm]", gemv_policy,
    ...
    CPM_SECTION_FUNCTOR("vec", [](dmat& a, dvec& b, dvec& c){ c = selected_helper(etl::gemm_impl::VEC, a * b); })
...
CPM_DIRECT_SECTION_TWO_PASS_NS_PF("r = a dot b (s)", dot_policy,
    ...
    CPM_SECTION_FUNCTOR("vec", [](svec& a, svec& b){ SELECTED_SECTION(etl::dot_impl::VEC) { float_ref += etl::dot(a, b); } })
