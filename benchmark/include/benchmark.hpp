...
using trans_front_policy = NARY_POLICY(
    /* B */ VALUES_POLICY(128, 128, 128, 128, 128, 128, 128, 128, 128, 256, 256, 256, 256, 256, 256, 256, 256, 256, 256),
    /* K */ VALUES_POLICY(14,  28,  28,  40,  40,  50,  64,  128, 256, 14,  28,  28,  40,  40,  50,  64,  128, 256, 512),
    /* N */ VALUES_POLICY(14,  14,  28,  28,  40,  50,  64,  128, 256, 14,  28,  28,  40,  40,  50,  64,  128, 256, 512));

using batch_hint_2d_policy = NARY_POLICY(
    /* B */ VALUES_POLICY(128, 128, 128, 128, 128, 128,  128,  128,  256, 256, 256, 256, 256, 256,  256,  256),
    /* K */ VALUES_POLICY(200, 300, 400, 400, 500, 1024, 2048, 4096, 200, 300, 400, 400, 500, 1024, 2048, 4096));

using batch_hint_4d_policy = NARY_POLICY(
    /* B */ VALUES_POLICY(128, 128, 128, 128, 128, 128, 128, 128, 256, 256, 256, 256, 256, 256, 256, 256),
    /* K */ VALUES_POLICY( 16,  16,  16,  16,  32,  32,  32,  32,  16,  16,  16,  16,  32,  32,  32,  32),
    /* M */ VALUES_POLICY( 28,  24,  16,  12,  28,  24,  16,  12,  28,  24,  16,  12,  28,  24,  16,  12),
    /* N */ VALUES_POLICY( 28,  24,  16,  12,  28,  24,  16,  12,  28,  24,  16,  12,  28,  24,  16,  12)
    );
