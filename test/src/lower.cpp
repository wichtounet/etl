...
TEMPLATE_TEST_CASE_2("lower/1", "[lower]", Z, float, double) {
    etl::lower_matrix<etl::fast_matrix<Z, 2,2>> a;
    etl::lower_matrix<etl::fast_matrix<Z, 1,1>> b;
    etl::lower_matrix<etl::fast_dyn_matrix<Z, 1,1>> c(Z(0.0));
...
TEMPLATE_TEST_CASE_2("lower/2", "[lower]", Z, float, double) {
    etl::lower_matrix<etl::fast_matrix<Z, 3, 3>> a;
...
TEMPLATE_TEST_CASE_2("lower/3", "[lower]", Z, float, double) {
    etl::lower_matrix<etl::dyn_matrix<Z>> a(3UL);

    REQUIRE_EQUALS(a(1, 1), Z(0.0));

    a(0, 0) += 5.5;

    REQUIRE_EQUALS(a(0, 0), Z(5.5));
...
TEMPLATE_TEST_CASE_2("lower/4", "[lower]", Z, float, double) {
    etl::fast_matrix<Z, 3, 3> a = {1.1, 0.0, 0.0, 1.2, 1.3, 0.0, 1.4, 1.5, 1.6};
    etl::lower_matrix<etl::fast_matrix<Z, 3, 3>> b;
    b = a;
...
TEMPLATE_TEST_CASE_2("lower/5", "[lower]", Z, float, double) {
    etl::fast_matrix<Z, 3, 3> a = {1.1, 0.0, 0.0, 1.2, 1.3, 0.0, 1.4, 1.5, 1.6};

    etl::lower_matrix<etl::dyn_matrix<Z>> b(3UL);
    b = a;

    etl::lower_matrix<etl::dyn_matrix<Z>> c(3UL);
    c = a;
...
TEMPLATE_TEST_CASE_2("lower/6", "[lower][fast]", Z, float, double) {
    etl::fast_matrix<Z, 3, 3> a = {1.1, 0.0, 0.0, 1.2, 1.3, 0.0, 1.4, 1.5, 1.6};
...
TEMPLATE_TEST_CASE_2("lower/7", "[lower][fast]", Z, float, double) {
...
TEMPLATE_TEST_CASE_2("lower/8", "[lower][fast]", Z, float, double) {
    etl::fast_matrix<Z, 3, 3> a = {1.1, 0.0, 0.0, 1.2, 1.3, 0.0, 1.4, 1.5, 1.6};
...
TEMPLATE_TEST_CASE_2("lower/9", "[lower][fast]", Z, float, double) {
    etl::fast_matrix<Z, 3, 3> a = {1.1, 0.0, 0.0, 1.2, 1.3, 0.0, 1.4, 1.5, 1.6};
