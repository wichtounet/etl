...
FFT_FUNCTOR(cufft_fft1, etl::impl::cufft::fft1(a, c))
FFT_FUNCTOR(cufft_fft2, etl::impl::cufft::fft2(a, c))
...
FFT_FUNCTOR(cufft_fft1_many, etl::impl::cufft::fft1_many(a, c))
FFT_FUNCTOR(cufft_fft2_many, etl::impl::cufft::fft2_many(a, c))
...
FFT_FUNCTOR(cufft_ifft1, etl::impl::cufft::ifft1(a, c))
FFT_FUNCTOR(cufft_ifft2, etl::impl::cufft::ifft2(a, c))
...
FFT_FUNCTOR(cufft_ifft1_real, etl::impl::cufft::ifft1_real(a, c))
FFT_FUNCTOR(cufft_ifft2_real, etl::impl::cufft::ifft2_real(a, c))
