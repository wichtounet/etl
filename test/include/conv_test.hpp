...
#ifdef TEST_SSE
CONV_FUNCTOR(sse_conv1_full, etl::impl::sse::conv1_full(a, b, c))
CONV_FUNCTOR(sse_conv1_same, etl::impl::sse::conv1_same(a, b, c))
CONV_FUNCTOR(sse_conv1_valid, etl::impl::sse::conv1_valid(a, b, c))
