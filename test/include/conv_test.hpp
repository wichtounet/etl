...
CONV_FUNCTOR(blas_conv4_valid_flipped, c = selected_helper(etl::conv4_impl::BLAS, (etl::conv_4d_valid_flipped<S1,S2,P1,P2>(a, b))))
...
CONV_FUNCTOR(blas_conv4_valid_filter, c = selected_helper(etl::conv4_impl::BLAS, (etl::conv_4d_valid_filter<S1, S2, P1, P2>(a, b))))
...
CONV_FUNCTOR(blas_conv4_valid_filter_flipped, c = selected_helper(etl::conv4_impl::BLAS, (etl::conv_4d_valid_filter_flipped<S1, S2, P1, P2>(a, b))))
...
CONV_FUNCTOR(fft_conv2_valid_multi, c = selected_helper(etl::conv_multi_impl::FFT, (etl::conv_2d_valid_multi<S1, S2, P1, P2>(a, b))))
...
CONV_FUNCTOR(fft_conv2_valid_multi_flipped, c = selected_helper(etl::conv_multi_impl::FFT, (etl::conv_2d_valid_multi_flipped<S1, S2, P1, P2>(a, b))))
...
CONV_FUNCTOR(fft_conv2_valid_multi_multi, c = selected_helper(etl::conv_multi_impl::FFT, (etl::conv_2d_valid_multi_multi<S1, S2, P1, P2>(a, b))))
...
CONV_FUNCTOR(fft_conv2_valid_multi_multi_flipped, c = selected_helper(etl::conv_multi_impl::FFT, (etl::conv_2d_valid_multi_multi_flipped<S1, S2, P1, P2>(a, b))))
...
#define CONV4_VALID_TEST_CASE_SECTION_BLAS CONV_TEST_CASE_SECTIONS(blas_conv4_valid)
...
#define CONV4_VALID_FLIPPED_TEST_CASE_SECTION_BLAS CONV_TEST_CASE_SECTIONS(blas_conv4_valid_flipped)
...
#define CONV4_VALID_FILTER_TEST_CASE_SECTION_BLAS CONV_TEST_CASE_SECTIONS(blas_conv4_valid_filter)
...
#define CONV4_VALID_FILTER_FLIPPED_TEST_CASE_SECTION_BLAS CONV_TEST_CASE_SECTIONS(blas_conv4_valid_filter_flipped)
...
CONV_FUNCTOR(sse_conv2_valid, c = selected_helper(etl::conv_impl::SSE, (etl::conv_2d_valid<S1, S2, P1, P2>(a, b))))
CONV_FUNCTOR(sse_conv2_valid_flipped, c = selected_helper(etl::conv_impl::SSE, (etl::conv_2d_valid_flipped<S1, S2, P1, P2>(a, b))))

DYN_CONV_FUNCTOR(sse_dyn_conv2_valid, c = selected_helper(etl::conv_impl::SSE, (etl::conv_2d_valid(a, b, s1, s2, p1, p2))))
DYN_CONV_FUNCTOR(sse_dyn_conv2_valid_flipped, c = selected_helper(etl::conv_impl::SSE, (etl::conv_2d_valid_flipped(a, b, s1, s2, p1, p2))))

DYN_CONV_FUNCTOR(sse_dyn_conv2_valid_multi, c = selected_helper(etl::conv_impl::SSE, (etl::conv_2d_valid_multi(a, b, s1, s2, p1, p2))))
DYN_CONV_FUNCTOR(sse_dyn_conv2_valid_multi_flipped, c = selected_helper(etl::conv_impl::SSE, (etl::conv_2d_valid_multi_flipped(a, b, s1, s2, p1, p2))))

CONV_FUNCTOR(sse_conv2_full_multi, c = selected_helper(etl::conv_multi_impl::SSE, etl::conv_2d_full_multi(a, b)))
CONV_FUNCTOR(sse_conv2_full_multi_flipped, c = selected_helper(etl::conv_multi_impl::SSE, etl::conv_2d_full_multi_flipped(a, b)))
CONV_FUNCTOR(sse_conv2_valid_multi, c = selected_helper(etl::conv_multi_impl::SSE, (etl::conv_2d_valid_multi<S1, S2, P1, P2>(a, b))))
CONV_FUNCTOR(sse_conv2_valid_multi_flipped, c = selected_helper(etl::conv_multi_impl::SSE, (etl::conv_2d_valid_multi_flipped<S1, S2, P1, P2>(a, b))))
CONV_FUNCTOR(sse_conv2_same_multi, c = selected_helper(etl::conv_multi_impl::SSE, etl::conv_2d_same_multi(a, b)))
CONV_FUNCTOR(sse_conv2_same_multi_flipped, c = selected_helper(etl::conv_multi_impl::SSE, etl::conv_2d_same_multi_flipped(a, b)))
CONV_FUNCTOR(sse_conv2_valid_multi_multi, c = selected_helper(etl::conv_multi_impl::SSE, (etl::conv_2d_valid_multi_multi<S1, S2, P1, P2>(a, b))))
CONV_FUNCTOR(sse_conv2_valid_multi_multi_flipped, c = selected_helper(etl::conv_multi_impl::SSE, (etl::conv_2d_valid_multi_multi_flipped<S1, S2, P1, P2>(a, b))))

CONV_FUNCTOR(sse_conv4_valid, c = selected_helper(etl::conv4_impl::SSE, (etl::conv_4d_valid<S1,S2,P1,P2>(a, b))))
CONV_FUNCTOR(sse_conv4_valid_flipped, c = selected_helper(etl::conv4_impl::SSE, (etl::conv_4d_valid_flipped<S1,S2,P1,P2>(a, b))))
CONV_FUNCTOR(sse_conv4_valid_filter, c = selected_helper(etl::conv4_impl::SSE, (etl::conv_4d_valid_filter<S1, S2, P1, P2>(a, b))))
CONV_FUNCTOR(sse_conv4_valid_filter_flipped, c = selected_helper(etl::conv4_impl::SSE, (etl::conv_4d_valid_filter_flipped<S1, S2, P1, P2>(a, b))))
CONV_FUNCTOR(sse_conv4_full, c = selected_helper(etl::conv4_impl::SSE, etl::conv_4d_full(a, b)))
CONV_FUNCTOR(sse_conv4_full_flipped, c = selected_helper(etl::conv4_impl::SSE, etl::conv_4d_full_flipped(a, b)))
...
#define CONV2_SAME_FLIPPED_TEST_CASE_SECTION_SSE CONV_TEST_CASE_SECTIONS(sse_conv2_same_flipped)
...
#define DYN_CONV2_VALID_TEST_CASE_SECTION_SSE CONV_TEST_CASE_SECTIONS(sse_dyn_conv2_valid)
#define DYN_CONV2_VALID_FLIPPED_TEST_CASE_SECTION_SSE CONV_TEST_CASE_SECTIONS(sse_dyn_conv2_valid_flipped)
#define DYN_CONV2_VALID_MULTI_TEST_CASE_SECTION_SSE CONV_TEST_CASE_SECTIONS(sse_dyn_conv2_valid_multi)
#define DYN_CONV2_VALID_MULTI_FLIPPED_TEST_CASE_SECTION_SSE CONV_TEST_CASE_SECTIONS(sse_dyn_conv2_valid_multi_flipped)

#define CONV2_FULL_MULTI_TEST_CASE_SECTION_SSE CONV_TEST_CASE_SECTIONS(sse_conv2_full_multi)
#define CONV2_FULL_MULTI_FLIPPED_TEST_CASE_SECTION_SSE CONV_TEST_CASE_SECTIONS(sse_conv2_full_multi_flipped)
#define CONV2_VALID_MULTI_TEST_CASE_SECTION_SSE CONV_TEST_CASE_SECTIONS(sse_conv2_valid_multi)
#define CONV2_VALID_MULTI_FLIPPED_TEST_CASE_SECTION_SSE CONV_TEST_CASE_SECTIONS(sse_conv2_valid_multi_flipped)
#define CONV2_SAME_MULTI_TEST_CASE_SECTION_SSE CONV_TEST_CASE_SECTIONS(sse_conv2_same_multi)
#define CONV2_SAME_MULTI_FLIPPED_TEST_CASE_SECTION_SSE CONV_TEST_CASE_SECTIONS(sse_conv2_same_multi_flipped)
#define CONV2_VALID_MULTI_MULTI_TEST_CASE_SECTION_SSE CONV_TEST_CASE_SECTIONS(sse_conv2_valid_multi_multi)
#define CONV2_VALID_MULTI_MULTI_FLIPPED_TEST_CASE_SECTION_SSE CONV_TEST_CASE_SECTIONS(sse_conv2_valid_multi_multi_flipped)

#define CONV4_VALID_TEST_CASE_SECTION_SSE CONV_TEST_CASE_SECTIONS(sse_conv4_valid)
#define CONV4_VALID_FLIPPED_TEST_CASE_SECTION_SSE CONV_TEST_CASE_SECTIONS(sse_conv4_valid_flipped)
#define CONV4_VALID_FILTER_TEST_CASE_SECTION_SSE CONV_TEST_CASE_SECTIONS(sse_conv4_valid_filter)
#define CONV4_VALID_FILTER_FLIPPED_TEST_CASE_SECTION_SSE CONV_TEST_CASE_SECTIONS(sse_conv4_valid_filter_flipped)
#define CONV4_FULL_TEST_CASE_SECTION_SSE CONV_TEST_CASE_SECTIONS(sse_conv4_full)
#define CONV4_FULL_FLIPPED_TEST_CASE_SECTION_SSE CONV_TEST_CASE_SECTIONS(sse_conv4_full_flipped)
#else
...
#define CONV2_SAME_FLIPPED_TEST_CASE_SECTION_SSE
#define CONV2_VALID_TEST_CASE_SECTION_SSE
#define CONV2_VALID_FLIPPED_TEST_CASE_SECTION_SSE
#define DYN_CONV2_VALID_TEST_CASE_SECTION_SSE
#define DYN_CONV2_VALID_FLIPPED_TEST_CASE_SECTION_SSE
#define DYN_CONV2_VALID_MULTI_TEST_CASE_SECTION_SSE
#define DYN_CONV2_VALID_MULTI_FLIPPED_TEST_CASE_SECTION_SSE

#define CONV2_FULL_MULTI_TEST_CASE_SECTION_SSE
#define CONV2_FULL_MULTI_FLIPPED_TEST_CASE_SECTION_SSE
#define CONV2_VALID_MULTI_TEST_CASE_SECTION_SSE
#define CONV2_VALID_MULTI_FLIPPED_TEST_CASE_SECTION_SSE
#define CONV2_SAME_MULTI_TEST_CASE_SECTION_SSE
#define CONV2_SAME_MULTI_FLIPPED_TEST_CASE_SECTION_SSE
#define CONV2_VALID_MULTI_MULTI_TEST_CASE_SECTION_SSE
#define CONV2_VALID_MULTI_MULTI_FLIPPED_TEST_CASE_SECTION_SSE

#define CONV4_VALID_TEST_CASE_SECTION_SSE
#define CONV4_VALID_FLIPPED_TEST_CASE_SECTION_SSE
#define CONV4_VALID_FILTER_TEST_CASE_SECTION_SSE
#define CONV4_VALID_FILTER_FLIPPED_TEST_CASE_SECTION_SSE
#define CONV4_FULL_TEST_CASE_SECTION_SSE
#define CONV4_FULL_FLIPPED_TEST_CASE_SECTION_SSE
#endif
...
CONV_FUNCTOR(avx_conv2_valid, c = selected_helper(etl::conv_impl::AVX, (etl::conv_2d_valid<S1, S2, P1, P2>(a, b))))
CONV_FUNCTOR(avx_conv2_valid_flipped, c = selected_helper(etl::conv_impl::AVX, (etl::conv_2d_valid_flipped<S1, S2, P1, P2>(a, b))))

DYN_CONV_FUNCTOR(avx_dyn_conv2_valid, c = selected_helper(etl::conv_impl::AVX, (etl::conv_2d_valid(a, b, s1, s2, p1, p2))))
DYN_CONV_FUNCTOR(avx_dyn_conv2_valid_flipped, c = selected_helper(etl::conv_impl::AVX, (etl::conv_2d_valid_flipped(a, b, s1, s2, p1, p2))))

DYN_CONV_FUNCTOR(avx_dyn_conv2_valid_multi, c = selected_helper(etl::conv_impl::AVX, (etl::conv_2d_valid_multi(a, b, s1, s2, p1, p2))))
DYN_CONV_FUNCTOR(avx_dyn_conv2_valid_multi_flipped, c = selected_helper(etl::conv_impl::AVX, (etl::conv_2d_valid_multi_flipped(a, b, s1, s2, p1, p2))))

CONV_FUNCTOR(avx_conv2_full_multi, c = selected_helper(etl::conv_multi_impl::AVX, etl::conv_2d_full_multi(a, b)))
CONV_FUNCTOR(avx_conv2_full_multi_flipped, c = selected_helper(etl::conv_multi_impl::AVX, etl::conv_2d_full_multi_flipped(a, b)))
CONV_FUNCTOR(avx_conv2_valid_multi, c = selected_helper(etl::conv_multi_impl::AVX, (etl::conv_2d_valid_multi<S1, S2, P1, P2>(a, b))))
CONV_FUNCTOR(avx_conv2_valid_multi_flipped, c = selected_helper(etl::conv_multi_impl::AVX, (etl::conv_2d_valid_multi_flipped<S1, S2, P1, P2>(a, b))))
CONV_FUNCTOR(avx_conv2_same_multi, c = selected_helper(etl::conv_multi_impl::AVX, etl::conv_2d_same_multi(a, b)))
CONV_FUNCTOR(avx_conv2_same_multi_flipped, c = selected_helper(etl::conv_multi_impl::AVX, etl::conv_2d_same_multi_flipped(a, b)))
CONV_FUNCTOR(avx_conv2_valid_multi_multi, c = selected_helper(etl::conv_multi_impl::AVX, (etl::conv_2d_valid_multi_multi<S1, S2, P1, P2>(a, b))))
CONV_FUNCTOR(avx_conv2_valid_multi_multi_flipped, c = selected_helper(etl::conv_multi_impl::AVX, (etl::conv_2d_valid_multi_multi_flipped<S1, S2, P1, P2>(a, b))))

CONV_FUNCTOR(avx_conv4_valid, c = selected_helper(etl::conv4_impl::AVX, (etl::conv_4d_valid<S1,S2,P1,P2>(a, b))))
CONV_FUNCTOR(avx_conv4_valid_flipped, c = selected_helper(etl::conv4_impl::AVX, (etl::conv_4d_valid_flipped<S1,S2,P1,P2>(a, b))))
CONV_FUNCTOR(avx_conv4_valid_filter, c = selected_helper(etl::conv4_impl::AVX, (etl::conv_4d_valid_filter<S1, S2, P1, P2>(a, b))))
CONV_FUNCTOR(avx_conv4_valid_filter_flipped, c = selected_helper(etl::conv4_impl::AVX, (etl::conv_4d_valid_filter_flipped<S1, S2, P1, P2>(a, b))))
CONV_FUNCTOR(avx_conv4_full, c = selected_helper(etl::conv4_impl::AVX, etl::conv_4d_full(a, b)))
CONV_FUNCTOR(avx_conv4_full_flipped, c = selected_helper(etl::conv4_impl::AVX, etl::conv_4d_full_flipped(a, b)))
...
#define CONV2_SAME_FLIPPED_TEST_CASE_SECTION_AVX CONV_TEST_CASE_SECTIONS(avx_conv2_same_flipped)
...
#define DYN_CONV2_VALID_TEST_CASE_SECTION_AVX CONV_TEST_CASE_SECTIONS(avx_dyn_conv2_valid)
#define DYN_CONV2_VALID_FLIPPED_TEST_CASE_SECTION_AVX CONV_TEST_CASE_SECTIONS(avx_dyn_conv2_valid_flipped)
#define DYN_CONV2_VALID_MULTI_TEST_CASE_SECTION_AVX CONV_TEST_CASE_SECTIONS(avx_dyn_conv2_valid_multi)
#define DYN_CONV2_VALID_MULTI_FLIPPED_TEST_CASE_SECTION_AVX CONV_TEST_CASE_SECTIONS(avx_dyn_conv2_valid_multi_flipped)

#define CONV2_FULL_MULTI_TEST_CASE_SECTION_AVX CONV_TEST_CASE_SECTIONS(avx_conv2_full_multi)
#define CONV2_FULL_MULTI_FLIPPED_TEST_CASE_SECTION_AVX CONV_TEST_CASE_SECTIONS(avx_conv2_full_multi_flipped)
#define CONV2_VALID_MULTI_TEST_CASE_SECTION_AVX CONV_TEST_CASE_SECTIONS(avx_conv2_valid_multi)
#define CONV2_VALID_MULTI_FLIPPED_TEST_CASE_SECTION_AVX CONV_TEST_CASE_SECTIONS(avx_conv2_valid_multi_flipped)
#define CONV2_SAME_MULTI_TEST_CASE_SECTION_AVX CONV_TEST_CASE_SECTIONS(avx_conv2_same_multi)
#define CONV2_SAME_MULTI_FLIPPED_TEST_CASE_SECTION_AVX CONV_TEST_CASE_SECTIONS(avx_conv2_same_multi_flipped)
#define CONV2_VALID_MULTI_MULTI_TEST_CASE_SECTION_AVX CONV_TEST_CASE_SECTIONS(avx_conv2_valid_multi_multi)
#define CONV2_VALID_MULTI_MULTI_FLIPPED_TEST_CASE_SECTION_AVX CONV_TEST_CASE_SECTIONS(avx_conv2_valid_multi_multi_flipped)

#define CONV4_VALID_TEST_CASE_SECTION_AVX CONV_TEST_CASE_SECTIONS(avx_conv4_valid)
#define CONV4_VALID_FLIPPED_TEST_CASE_SECTION_AVX CONV_TEST_CASE_SECTIONS(avx_conv4_valid_flipped)
#define CONV4_VALID_FILTER_TEST_CASE_SECTION_AVX CONV_TEST_CASE_SECTIONS(avx_conv4_valid_filter)
#define CONV4_VALID_FILTER_FLIPPED_TEST_CASE_SECTION_AVX CONV_TEST_CASE_SECTIONS(avx_conv4_valid_filter_flipped)
#define CONV4_FULL_TEST_CASE_SECTION_AVX CONV_TEST_CASE_SECTIONS(avx_conv4_full)
#define CONV4_FULL_FLIPPED_TEST_CASE_SECTION_AVX CONV_TEST_CASE_SECTIONS(avx_conv4_full_flipped)
#else
...
#define CONV2_SAME_FLIPPED_TEST_CASE_SECTION_AVX
#define CONV2_VALID_TEST_CASE_SECTION_AVX
#define CONV2_VALID_FLIPPED_TEST_CASE_SECTION_AVX
#define DYN_CONV2_VALID_TEST_CASE_SECTION_AVX
#define DYN_CONV2_VALID_FLIPPED_TEST_CASE_SECTION_AVX
#define DYN_CONV2_VALID_MULTI_TEST_CASE_SECTION_AVX
#define DYN_CONV2_VALID_MULTI_FLIPPED_TEST_CASE_SECTION_AVX

#define CONV2_FULL_MULTI_TEST_CASE_SECTION_AVX
#define CONV2_FULL_MULTI_FLIPPED_TEST_CASE_SECTION_AVX
#define CONV2_VALID_MULTI_TEST_CASE_SECTION_AVX
#define CONV2_VALID_MULTI_FLIPPED_TEST_CASE_SECTION_AVX
#define CONV2_SAME_MULTI_TEST_CASE_SECTION_AVX
#define CONV2_SAME_MULTI_FLIPPED_TEST_CASE_SECTION_AVX
#define CONV2_VALID_MULTI_MULTI_TEST_CASE_SECTION_AVX
#define CONV2_VALID_MULTI_MULTI_FLIPPED_TEST_CASE_SECTION_AVX

#define CONV4_VALID_TEST_CASE_SECTION_AVX
#define CONV4_VALID_FLIPPED_TEST_CASE_SECTION_AVX
#define CONV4_VALID_FILTER_TEST_CASE_SECTION_AVX
#define CONV4_VALID_FILTER_FLIPPED_TEST_CASE_SECTION_AVX
#define CONV4_FULL_TEST_CASE_SECTION_AVX
#define CONV4_FULL_FLIPPED_TEST_CASE_SECTION_AVX
#endif
...
CONV_FUNCTOR(cudnn_conv4_valid_filter, c = selected_helper(etl::conv4_impl::CUDNN, (etl::conv_4d_valid_filter<S1, S2, P1, P2>(a, b))))
CONV_FUNCTOR(cudnn_conv4_valid_filter_flipped, c = selected_helper(etl::conv4_impl::CUDNN, (etl::conv_4d_valid_filter_flipped<S1, S2, P1, P2>(a, b))))
...
#define CONV2_SAME_FLIPPED_TEST_CASE(name, description) \
    CONV_TEST_CASE_DECL(name, description) {    \
        ...
        CONV2_SAME_FLIPPED_TEST_CASE_SECTION_SSE        \
        CONV2_SAME_FLIPPED_TEST_CASE_SECTION_AVX        \
    }                                           \
    CONV_TEST_CASE_DEFN
...
#define DYN_CONV2_VALID_TEST_CASE(name, description) \
    CONV_TEST_CASE_DECL(name, description) {     \
        ...
        DYN_CONV2_VALID_TEST_CASE_SECTION_SSE        \
        DYN_CONV2_VALID_TEST_CASE_SECTION_AVX        \
...
#define DYN_CONV2_VALID_FLIPPED_TEST_CASE(name, description) \
    CONV_TEST_CASE_DECL(name, description) {             \
        ...
        DYN_CONV2_VALID_FLIPPED_TEST_CASE_SECTION_SSE        \
        DYN_CONV2_VALID_FLIPPED_TEST_CASE_SECTION_AVX        \
...
#define CONV4_VALID_TEST_CASE(name, description) \
    CONV_TEST_CASE_DECL(name, description) {     \
        ...
        CONV4_VALID_TEST_CASE_SECTION_BLAS       \
        CONV4_VALID_TEST_CASE_SECTION_SSE        \
        CONV4_VALID_TEST_CASE_SECTION_AVX        \
...
#define CONV4_VALID_FLIPPED_TEST_CASE(name, description) \
    CONV_TEST_CASE_DECL(name, description) {             \
        ...
        CONV4_VALID_FLIPPED_TEST_CASE_SECTION_BLAS       \
        CONV4_VALID_FLIPPED_TEST_CASE_SECTION_SSE        \
        CONV4_VALID_FLIPPED_TEST_CASE_SECTION_AVX        \
...
#define CONV4_FULL_FLIPPED_TEST_CASE(name, description) \
    CONV_TEST_CASE_DECL(name, description) {            \
        ...
        CONV4_FULL_FLIPPED_TEST_CASE_SECTION_SSE        \
        CONV4_FULL_FLIPPED_TEST_CASE_SECTION_AVX        \
...
#define CONV2_VALID_MULTI_TEST_CASE(name, description) \
    CONV_TEST_CASE_DECL(name, description) {           \
        ...
        CONV2_VALID_MULTI_TEST_CASE_SECTION_SSE        \
        CONV2_VALID_MULTI_TEST_CASE_SECTION_AVX        \
...
#define CONV2_VALID_MULTI_FLIPPED_TEST_CASE(name, description) \
    CONV_TEST_CASE_DECL(name, description) {                   \
        ...
        CONV2_VALID_MULTI_FLIPPED_TEST_CASE_SECTION_SSE        \
        CONV2_VALID_MULTI_FLIPPED_TEST_CASE_SECTION_AVX        \
...
#define DYN_CONV2_VALID_MULTI_TEST_CASE(name, description) \
    CONV_TEST_CASE_DECL(name, description) {               \
        ...
        DYN_CONV2_VALID_MULTI_TEST_CASE_SECTION_SSE        \
        DYN_CONV2_VALID_MULTI_TEST_CASE_SECTION_AVX        \
        DYN_CONV2_VALID_MULTI_TEST_CASE_SECTION_FFT        \
        DYN_CONV2_VALID_MULTI_TEST_CASE_SECTION_BLAS       \
...
#define DYN_CONV2_VALID_MULTI_FLIPPED_TEST_CASE(name, description) \
    CONV_TEST_CASE_DECL(name, description) {                       \
        ...
        DYN_CONV2_VALID_MULTI_FLIPPED_TEST_CASE_SECTION_SSE        \
        DYN_CONV2_VALID_MULTI_FLIPPED_TEST_CASE_SECTION_AVX        \
        DYN_CONV2_VALID_MULTI_FLIPPED_TEST_CASE_SECTION_FFT        \
        DYN_CONV2_VALID_MULTI_FLIPPED_TEST_CASE_SECTION_BLAS       \
...
#define CONV2_VALID_MULTI_MULTI_TEST_CASE(name, description) \
    CONV_TEST_CASE_DECL(name, description) {                 \
        ...
        CONV2_VALID_MULTI_MULTI_TEST_CASE_SECTION_SSE        \
        CONV2_VALID_MULTI_MULTI_TEST_CASE_SECTION_AVX        \
        CONV2_VALID_MULTI_MULTI_TEST_CASE_SECTION_BLAS       \
...
#define CONV2_VALID_MULTI_MULTI_FLIPPED_TEST_CASE(name, description) \
    CONV_TEST_CASE_DECL(name, description) {                         \
        ...
        CONV2_VALID_MULTI_MULTI_FLIPPED_TEST_CASE_SECTION_SSE        \
        CONV2_VALID_MULTI_MULTI_FLIPPED_TEST_CASE_SECTION_AVX        \
        CONV2_VALID_MULTI_MULTI_FLIPPED_TEST_CASE_SECTION_BLAS       \
...
#define CONV2_FULL_MULTI_TEST_CASE(name, description) \
    CONV_TEST_CASE_DECL(name, description) {          \
        ...
        CONV2_FULL_MULTI_TEST_CASE_SECTION_SSE        \
        CONV2_FULL_MULTI_TEST_CASE_SECTION_AVX        \
...
#define CONV2_SAME_MULTI_TEST_CASE(name, description) \
    CONV_TEST_CASE_DECL(name, description) {          \
        ...
        CONV2_SAME_MULTI_TEST_CASE_SECTION_SSE        \
        CONV2_SAME_MULTI_TEST_CASE_SECTION_AVX        \
    }                                                 \
    CONV_TEST_CASE_DEFN
...
#define CONV2_SAME_MULTI_FLIPPED_TEST_CASE(name, description) \
    CONV_TEST_CASE_DECL(name, description) {                  \
        ...
        CONV2_SAME_MULTI_FLIPPED_TEST_CASE_SECTION_SSE        \
        CONV2_SAME_MULTI_FLIPPED_TEST_CASE_SECTION_AVX        \
    }                                                         \
    CONV_TEST_CASE_DEFN
