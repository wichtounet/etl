...
CONV_FUNCTOR(sse_conv4_valid, c = selected_helper(etl::conv_impl::SSE, etl::conv_4d_valid(a, b)))
CONV_FUNCTOR(sse_conv4_valid_flipped, c = selected_helper(etl::conv_impl::SSE, etl::conv_4d_valid_flipped(a, b)))
